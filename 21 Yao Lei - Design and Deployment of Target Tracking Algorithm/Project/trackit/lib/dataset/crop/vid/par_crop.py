...
VID_base_path = '/media/yl/datasets/ILSVRC2015/ILSVRC2015'
...
def crop_video(sub_set, video, crop_path, instanc_size):
    ...
    # if isdir(video_crop_base_path): return
    if video != "ILSVRC2015_train_00479002": return
...
def main(instanc_size=511, num_threads=24):
    ...
    crop_path = '/media/yl/datasets/ILSVRC2015/ILSVRC2015/Data/VID/crop{:d}'.format(instanc_size)
