...
class OceanDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # center box -> conner box, and crop image object at image center
    ...
    def _augmentation(self, image, bbox, size, search=False):
        ...
        param = edict()
        # notice attention              self.shift_s: 64
        if search:
    ...
    def _create_dynamic_logisticloss_label(self, label_size, c_shift, rPos=2, rNeg=0):
        if isinstance(label_size, int):
            ...
            sz = label_size[0]
        # this 8 -> stride, Change the stride of the backbone, and make the corresponding changes here
