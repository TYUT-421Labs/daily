...
json.dump(train, open('/media/yl/datasets/ILSVRC2015/ILSVRC2015/Data/VID/crop511/train.json', 'w'), indent=4, sort_keys=True)
json.dump(val, open('/media/yl/datasets/ILSVRC2015/ILSVRC2015/Data/VID/crop511/val.json', 'w'), indent=4, sort_keys=True)
print('done!')
