...
# vid
config.OCEAN.DATASET.VID.PATH = 'data/vid/crop511'
config.OCEAN.DATASET.VID.ANNOTATION = 'data/vid/train.json'

# got10k
config.OCEAN.DATASET.GOT10K.PATH = 'data/got10k/crop511'
config.OCEAN.DATASET.GOT10K.ANNOTATION = 'data/got10k/train.json'
config.OCEAN.DATASET.GOT10K.RANGE = 100
config.OCEAN.DATASET.GOT10K.USE = 200000

# visdrone
config.OCEAN.DATASET.VISDRONE.ANNOTATION = 'data/visdrone/train.json'
config.OCEAN.DATASET.VISDRONE.PATH = 'data/visdrone/crop271'
