...
from .connect import single_tower, AdjustLayer, AlignHead, Corr_Up, MultiDiCorr, OceanCorr, box_tower
from .backbones import ResNet50, ResNet22W
from .mask import MMS, MSS
from .modules import MultiFeatureBase
from lib.models.VGG_Ocean_ import VGG_Ocean_
import os
import sys
...
from lib.models.RepVGG import MobileOne, reparameterize_model
from lib.models.Alexnet import AlexNetV1
...
class VGG_Ocean(VGG_Ocean_):
    def __init__(self, align=False, online=False):
        super(VGG_Ocean, self).__init__()
        self.features = MobileOne()  # in param
        # self.features = AlexNetV1()
        # self.neck = AdjustLayer(in_channels=1024, out_channels=256)
        self.connect_model = single_tower(inchannels=256, outchannels=256, towernum=1)
        # self.align_head = AlignHead(256, 256) if align else None
...
class OceanTRT(OceanTRT_):
    def __init__(self, online=False, align=False):
        ...
        self.connect_model1 = single_tower(inchannels=256, outchannels=256, towernum=4)
...
class OceanPlus(OceanPlus_):
    def __init__(self, online=False, mms=False):
        ...
        self.features = ResNet50(used_layers=[3], online=online)  # in param
        self.neck = AdjustLayer(in_channels=1024, out_channels=256)
        self.connect_model = single_tower(inchannels=256, outchannels=256, towernum=4)
