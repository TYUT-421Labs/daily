...
from lib.tracker.oceanplus import OceanPlus
...
net = models.__dict__[info.arch](online=info.online, mms=True)
net = load_pretrain(net, "$tracker_path/snapshot/OceanPlusMMS.pth")
net.eval()
net = net.cuda()
