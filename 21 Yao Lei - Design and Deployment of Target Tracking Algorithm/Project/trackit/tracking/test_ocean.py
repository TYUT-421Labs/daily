...
from lib.tracker.ocean import Ocean
from lib.tracker.VGG_ocean import VGG_Ocean
from lib.tracker.online import ONLINE
...
def parse_args():
    ...
    parser.add_argument('--arch', dest='arch', default='VGG_Ocean', help='backbone architecture')
    parser.add_argument('--resume', default="snapshot/checkpoint_e50.pth", type=str, help='pretrained model')
    parser.add_argument('--dataset', default='OTB100', help='dataset test')
    parser.add_argument('--epoch_test', default=True, type=bool, help='multi-gpu epoch test flag')
...
def main():
    ...
    siam_tracker = VGG_Ocean(siam_info)
    ...
    siam_net.eval()
    if 'VGG' in args.arch:
        siam_net.features = reparameterize_model(siam_net.features)
