...
def parse_args():
    ...
    parser.add_argument('--resume', default='/home/dempsey/Desktop/SiamDW-ori/pth/CIResNet22_RPN.pth', type=str, help='pretrained model')
    parser.add_argument('--video', default='/home/dempsey/Desktop/SiamDW-ori/video/Screenrecording_20220930_195115.mp4', type=str, help='video file path')
